...
define('forms',['exports', 'aurelia-validation', 'aurelia-framework'], function (exports, _aureliaValidation, _aureliaFramework) {
	'use strict';
	...
	var Forms = exports.Forms = (_dec = (0, _aureliaFramework.inject)(_aureliaFramework.NewInstance.of(_aureliaValidation.ValidationController)), _dec(_class = function () {
		function Forms(controller) {
			...
			_aureliaValidation.ValidationRules.ensure(function (m) {
				return m.animal;
			}).required().on(this);
		}
		...
		Forms.prototype.executeValidation = function executeValidation() {
